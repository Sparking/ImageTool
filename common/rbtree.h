...
#define rb_parent(rb)       ((struct rb_node *)(((char *)NULL) + (((rb)->__rb_parent_color & ~3))))
#define rb_color(rb)        ((rb)->__rb_parent_color & 1)
#define rb_is_red(rb)       (!rb_color(rb))
#define rb_is_black(rb)     rb_color(rb)
#define rb_set_red(rb)      do { (rb)->__rb_parent_color &= ~1; } while (0)
#define rb_set_black(rb)    do { (rb)->__rb_parent_color |= 1; } while(0)

static inline void rb_set_parent(struct rb_node *rb, struct rb_node *p)
{
    rb->__rb_parent_color = (unsigned long)(rb_color(rb) | (((char *)p) - ((char *)NULL)));
}

static inline void rb_set_color(struct rb_node *rb, unsigned color)
{
    rb->__rb_parent_color = (unsigned long)((rb->__rb_parent_color & ~1) | color);
}

static inline void rb_set_parent_color(struct rb_node *rb, struct rb_node *p,
            unsigned color)
{
    rb->__rb_parent_color = (unsigned long)((((char *)p) - ((char *)NULL)) | color);
}
...
#define RB_EMPTY_NODE(rb)   ((rb)->__rb_parent_color == (unsigned long)(((char *)(rb)) - ((char *)NULL)))
#define RB_CLEAR_NODE(rb)   ((rb)->__rb_parent_color = (unsigned long)(((char *)(rb)) - ((char *)NULL)))
...
{
    node->__rb_parent_color = (unsigned long)((((char *)parent) - ((char *)NULL)));
